<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('module/add',array("class"=>"form-horizontal")); ?>

              	<div class="box-body">
                	<div class="form-group">
						<label for="MODULE_NAME" class="col-md-4 control-label">MODULE NAME</label>
						<div class="col-md-8">
							<input type="text" name="MODULE_NAME" value="<?php echo $this->input->post('MODULE_NAME'); ?>" class="form-control" id="MODULE_NAME" />
						</div>
					</div>
					<div class="form-group">
