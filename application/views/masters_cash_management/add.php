<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('masters_cash_management/add',array("class"=>"form-horizontal")); ?>

              	<div class="box-body">
                	<div class="form-group">
						<label for="CASHMANAGEMENT_DATE" class="col-md-4 control-label">CASHMANAGEMENT DATE</label>
						<div class="col-md-8">
							<input type="text" name="CASHMANAGEMENT_DATE" value="<?php echo $this->input->post('CASHMANAGEMENT_DATE'); ?>" class="form-control" id="CASHMANAGEMENT_DATE" />
						</div>
					</div>
					<div class="form-group">
						<label for="CASHMANAGEMENT_AMOUNT" class="col-md-4 control-label">CASHMANAGEMENT AMOUNT</label>
						<div class="col-md-8">
							<input type="text" name="CASHMANAGEMENT_AMOUNT" value="<?php echo $this->input->post('CASHMANAGEMENT_AMOUNT'); ?>" class="form-control" id="CASHMANAGEMENT_AMOUNT" />
						</div>
					</div>
					<div class="form-group">
						<label for="CASHMANAGEMENT_RETURN_AMOUNT" class="col-md-4 control-label">CASHMANAGEMENT RETURN AMOUNT</label>
						<div class="col-md-8">
							<input type="text" name="CASHMANAGEMENT_RETURN_AMOUNT" value="<?php echo $this->input->post('CASHMANAGEMENT_RETURN_AMOUNT'); ?>" class="form-control" id="CASHMANAGEMENT_RETURN_AMOUNT" />
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="CASHMANAGEMENT_ASSIGNEDTO" value="<?php echo $this->input->post('CASHMANAGEMENT_ASSIGNEDTO'); ?>" class="form-control" id="CASHMANAGEMENT_ASSIGNEDTO" />
						</div>
					</div>
				</div>
