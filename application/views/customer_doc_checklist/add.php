<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('customer_doc_checklist/add',array("class"=>"form-horizontal")); ?>
              	...
              	<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="DOCUMENT_ID" value="<?php echo $this->input->post('DOCUMENT_ID'); ?>" class="form-control" id="DOCUMENT_ID" />
						</div>
					</div>
					<div class="form-group">
						<label for="DOCUMENT_PIC_PATH" class="col-md-4 control-label">DOCUMENT PIC PATH</label>
						<div class="col-md-8">
							<input type="text" name="DOCUMENT_PIC_PATH" value="<?php echo $this->input->post('DOCUMENT_PIC_PATH'); ?>" class="form-control" id="DOCUMENT_PIC_PATH" />
						</div>
					</div>
					<div class="form-group">
