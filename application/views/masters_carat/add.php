<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('masters_carat/add',array("class"=>"form-horizontal")); ?>

              	<div class="box-body">
                	<div class="form-group">
						<label for="CARAT_NAME" class="col-md-4 control-label">CARAT NAME</label>
						<div class="col-md-8">
							<input type="text" name="CARAT_NAME" value="<?php echo $this->input->post('CARAT_NAME'); ?>" class="form-control" id="CARAT_NAME" />
						</div>
					</div>
					<div class="form-group">
