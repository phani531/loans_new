<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('masters_holiday_info/add',array("class"=>"form-horizontal")); ?>

              	<div class="box-body">
                	<div class="form-group">
						<label for="HOLIDAY_NAME" class="col-md-4 control-label">HOLIDAY NAME</label>
						<div class="col-md-8">
							<input type="text" name="HOLIDAY_NAME" value="<?php echo $this->input->post('HOLIDAY_NAME'); ?>" class="form-control" id="HOLIDAY_NAME" />
						</div>
					</div>
					<div class="form-group">
						<label for="HOLIDAY_FROM_DATE" class="col-md-4 control-label">HOLIDAY FROM DATE</label>
						<div class="col-md-8">
							<input type="text" name="HOLIDAY_FROM_DATE" value="<?php echo $this->input->post('HOLIDAY_FROM_DATE'); ?>" class="form-control" id="HOLIDAY_FROM_DATE" />
						</div>
					</div>
					<div class="form-group">
						<label for="HOLIDAY_TO_DATE" class="col-md-4 control-label">HOLIDAY TO DATE</label>
						<div class="col-md-8">
							<input type="text" name="HOLIDAY_TO_DATE" value="<?php echo $this->input->post('HOLIDAY_TO_DATE'); ?>" class="form-control" id="HOLIDAY_TO_DATE" />
						</div>
					</div>
					<div class="form-group">
