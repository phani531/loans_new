<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('masters_housestatu/add',array("class"=>"form-horizontal")); ?>

              	<div class="box-body">
                	<div class="form-group">
						<label for="HOUSESTATUS_NAME" class="col-md-4 control-label">HOUSESTATUS NAME</label>
						<div class="col-md-8">
							<input type="text" name="HOUSESTATUS_NAME" value="<?php echo $this->input->post('HOUSESTATUS_NAME'); ?>" class="form-control" id="HOUSESTATUS_NAME" />
						</div>
					</div>
					<div class="form-group">
