<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('masters_ornament/add',array("class"=>"form-horizontal")); ?>

              	<div class="box-body">
                	<div class="form-group">
						<label for="ORNAMENT_NAME" class="col-md-4 control-label">ORNAMENT NAME</label>
						<div class="col-md-8">
							<input type="text" name="ORNAMENT_NAME" value="<?php echo $this->input->post('ORNAMENT_NAME'); ?>" class="form-control" id="ORNAMENT_NAME" />
						</div>
					</div>
					<div class="form-group">
