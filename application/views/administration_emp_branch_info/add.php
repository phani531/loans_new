<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('administration_emp_branch_info/add',array("class"=>"form-horizontal")); ?>
					...
					<div class="form-group">
							...
							<div class="col-md-8">
								<select name="BRANCH_ID" class="form-control">
									...
									{
										$selected = ($administration_comp_profile['BRANCH_ID'] == $this->input->post('BRANCH_ID')) ? ' selected="selected"' : "";
